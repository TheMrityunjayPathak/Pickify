...
def extract_keyword(obj):
    ...
    Returns:
        pd.Series: A Series containing list of keywords corresponding to the 'name' key of each dictionary.
    ...
    Example:
        >>> extract_keyword('[{"id": 28, "name": "Spy"}, {"id": 12, "name": "Future"}]')
        ['Spy', 'Future']
    """
    try:
